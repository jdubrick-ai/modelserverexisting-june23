...
3) Access the `workbench` named `modelserverexisting-june23-notebook`.
...
5) In the terminal, run `cd modelserverexisting-june23` to navigate to your sample app's directory.
